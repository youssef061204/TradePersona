...
Files are limited to 50 MiB / 500,000 rows. Malformed rows reject the upload with quality details. Exact repeated behavioral records are removed with a warning. See the [API/input contract](docs/CONTRACT.md).
